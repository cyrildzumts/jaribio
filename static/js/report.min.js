...
define('commons',['ajax_api','element_utils'], function(ajax_api, element_utils) {
    'use strict';
    var fileUpload;
    var productManager;
    let quizManager;
