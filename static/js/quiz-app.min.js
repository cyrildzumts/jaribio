...
define('quiz/step',['ajax_api','tag_api'], function(Ajax,TagApi){
    class QuizStep {
...
define('quiz/question',['ajax_api','tag_api'], function(Ajax,TagApi){
...
define('quiz/answer',['ajax_api','tag_api'], function(Ajax,TagApi){
    class Answer {
        constructor(answer){
            this.id = answer.id;
...
define('quiz/quiz',['ajax_api', 'tag_api', 'quiz/step', 'quiz/question','quiz/answer' ],function(Ajax, TagApi, QuizStep, Question,Answer){
...
define('commons',['ajax_api','tag_api', 'filters'], function(ajax_api, tag_api,Filters) {
    'use strict';
    var fileUpload;
    var productManager;
    let quizManager;
