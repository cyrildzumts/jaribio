define(['ajax_api','element_utils'], function(ajax_api, element_utils) {
    ...
    var QuestionManager = (function(){
        ...
        QuestionManager.prototype.add_response = function(){
            ...
            let form_management_initial_input = element_utils.create_input({'name': this.answer_formset_initial_form, 'value': 0, 'type': 'hidden', 'id': this.answer_formset_initial_form});
