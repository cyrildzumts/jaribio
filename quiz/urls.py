...
quiz_patterns = [
    ...
    path('<uuid:quiz_slug>/questions/<uuid:question_uuid>/update/', views.update_question, name="question-update"),
    path('<uuid:quiz_slug>/questions/<uuid:question_uuid>/', views.question_details, name="question-details"),
