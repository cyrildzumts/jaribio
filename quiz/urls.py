...
quiz_patterns = [
    ...
    path('quiz/<uuid:quiz_slug>/questions/<uuid:question_uuid>/update/', views.update_question, name="question-update"),
    path('quiz/<uuid:quiz_slug>/questions/<uuid:question_uuid>/', views.question_details, name="question-details"),
